...
<%!private Connection con;
	...
	public void jspInit() {
		...
		try {
			...
			//create sequence jsp_acno_seq start with 1000 increment by 1;
			ps1 = con.prepareStatement("INSERT INTO JSP_BANK_ACCOUNT VALUES(JSP_ACNO_SEQ.NEXTVAL,?,?,?)");
			ps2 = con.prepareStatement("SELECT ACNO,NAME,ADDRESS,BALANCE FROM JSP_BANK_ACCOUNT");
		} //try
 ...
 <%
     ...
     if(type.equalsIgnoreCase("submit")){
    	 ...
    	 System.out.println(name+" "+addrs+" "+balance);
    	...
    	<% } //else
    	 ...
    	 rs=ps2.executeQuery();  %>
    	   <table border="1"  align="center" bgcolor="cyan">
    	      <tr><th>acno </th> <th> name</th><th>Address</th> <th>Balance </th> </tr>
    	   <%
