...
import com.nt.dbcon.DBConnection;

public class BookDAOImpl implements BookDAO {

	private static final String GET_BOOKS_BY_CATEGORY = "SELECT BOOKID,BOOKNAME,CATEGORY,AUTHOR,PRICE,STATUS  FROM BOOK_STORE WHERE CATEGORY=?";
