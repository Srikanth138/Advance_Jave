...
<%!  public void  jspInit(){
	              /* System.out.println("dbuser name::"+config.getInitParameter("dbuser")); config and application are not work here in jspInit param's
             ...
             <%  Class.forName("java.util.Date");
                      System.out.println("driver loaded"+new java.util.Date());
             %>